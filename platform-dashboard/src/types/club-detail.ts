...
export type ClubUserRole = "SUPER_ADMIN" | "CLUB_ADMIN" | "STAFF" | "MEMBER" |
  "PLATFORM_ADMIN" | "SALES_REP" | "SUPPORT_REP" | "MARKETING";

export type ClubUserStatus = "ACTIVE" | "INACTIVE" | "LOCKED" | "PENDING_VERIFICATION";
...
export interface ClubUserStats {
  ...
  inactive: number;
  locked: number;
  byRole: Record<ClubUserRole, number>;
}
