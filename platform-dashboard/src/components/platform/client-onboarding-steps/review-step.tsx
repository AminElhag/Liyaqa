      ...
      <CardContent className="space-y-6">
        ...
        >
          ...
          <div className="ps-6 space-y-2 border-s-2 border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-1.5">
              <InfoRow isRtl={isRtl} label={texts.tradeName} value={values.organizationTradeNameEn} valueAr={values.organizationTradeNameAr} />
              {values.organizationType && (
                <InfoRow isRtl={isRtl} label={texts.type} value={values.organizationType} />
              )}
              <InfoRow isRtl={isRtl} icon={Mail} label={texts.email} value={values.organizationEmail} />
              <InfoRow isRtl={isRtl} icon={Phone} label={texts.phone} value={values.organizationPhone} />
              <InfoRow isRtl={isRtl} icon={Globe} label={texts.website} value={values.organizationWebsite} />
              <InfoRow isRtl={isRtl} icon={FileText} label={texts.vat} value={values.vatRegistrationNumber} />
              <InfoRow isRtl={isRtl} icon={FileText} label={texts.cr} value={values.commercialRegistrationNumber} />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="ps-6 space-y-2 border-s-2 border-emerald-200 dark:border-emerald-800">
            ...
            {values.clubSlug && (
              <InfoRow isRtl={isRtl} icon={Globe} label={texts.subdomain} value={`${values.clubSlug}.liyaqa.com`} />
            )}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="ps-6 space-y-2 border-s-2 border-amber-200 dark:border-amber-800">
            ...
            <div className="space-y-1.5">
              <InfoRow isRtl={isRtl} icon={Mail} label={texts.email} value={values.adminEmail} />
              <div className={cn("flex items-center gap-2 text-sm", isRtl && "flex-row-reverse")}>
