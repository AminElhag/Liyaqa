 ...
 */
function ChangeIndicator({ change }: { change?: number; locale: string }) {
                ...
                <Button
                  ...
                  onClick={() => {
                    const routes: Record<LifecycleStage, string> = {
                      TRIAL: "/clients?status=TRIAL",
                      ONBOARDING: "/clients?status=ONBOARDING",
                      ACTIVE: "/clients?status=ACTIVE",
                      AT_RISK: "/health?risk=HIGH",
                      CHURNED: "/clients?status=CHURNED",
                    };
                    navigate(routes[activeSelection]);
                  }}
                >
                  {texts.viewDetails}
