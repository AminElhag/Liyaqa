...
import type { ClientInvoice, ClientInvoiceLineItemType, CreateLineItemRequest } from "@/types";
...
export function InvoiceForm({ invoice, mode }: InvoiceFormProps) {
  ...
  // Fetch data
  const { data: clientsData, isLoading: loadingClients } = useClients({ size: 100 });
