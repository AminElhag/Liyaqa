...
-- ============================================
-- Purpose: Remove ALL data except the liyaqasaas@gmail.com Platform Administrator.
-- Preserves: flyway_schema_history, permissions, role_default_permissions, client_plans, shedlock
-- Run manually: psql -h localhost -p 5434 -U liyaqa -d liyaqa -f backend/cleanup-data.sql
-- ============================================
...
-- ============================================
SELECT 'platform_users' AS table_name, COUNT(*) AS row_count FROM platform_users
UNION ALL SELECT 'users', COUNT(*) FROM users
UNION ALL SELECT 'organizations', COUNT(*) FROM organizations
UNION ALL SELECT 'clubs', COUNT(*) FROM clubs
UNION ALL SELECT 'members', COUNT(*) FROM members
UNION ALL SELECT 'permissions', COUNT(*) FROM permissions
UNION ALL SELECT 'role_default_permissions', COUNT(*) FROM role_default_permissions
UNION ALL SELECT 'client_plans', COUNT(*) FROM client_plans;
