...
export function ConvertDealForm({ deal, onSubmit, onCancel, isSubmitting }: ConvertDealFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      organizationNameEn: deal.facilityName || "",
      organizationNameAr: "",
      ...
      clubNameEn: deal.facilityName ? `${deal.facilityName} Club` : "",
      clubNameAr: "",
      clubDescriptionEn: "",
      clubDescriptionAr: "",
      ...
      clientPlanId: "",
      agreedPriceAmount: deal.estimatedValue || 0,
      agreedPriceCurrency: deal.currency || "SAR",
