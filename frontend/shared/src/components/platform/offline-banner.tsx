    ...
    <AnimatePresence>
      {isOffline && (
        <motion.div
          ...
          className="fixed inset-x-0 top-0 z-[200] flex items-center justify-center gap-3 bg-destructive px-4 py-2.5 text-sm font-medium text-destructive-foreground"
          role="alert"
          aria-live="assertive"
        >
