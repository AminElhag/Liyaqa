...
import { ALERT_PLAYBOOKS, ALERT_SEVERITY_CONFIG } from "@liyaqa/shared/types/platform/alerts";
          ...
          >
            ...
            <div className={cn("flex-1", isRtl && "text-right")}>
              ...
              <DialogDescription>
                ...
                {isRtl ? severityConfig.labelAr : severityConfig.labelEn}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
          ...
          >
            ...
            {alert.organizationId && (
              <Button
                ...
                size="sm"
                onClick={() => {
                  router.push(`/${locale}/platform/clients/${alert.organizationId}`);
                  onClose();
                }}
              >
