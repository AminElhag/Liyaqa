...
import { useRecordClientPayment } from "@/queries/platform/use-client-invoices";
import { useToast } from "@/hooks/use-toast";
import type { ClientInvoice, ClientPaymentMethod } from "@/types/platform/client-invoice";
