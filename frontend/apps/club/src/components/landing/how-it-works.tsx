...
const steps: Step[] = [
  {
    ...
    titleEn: "Sign Up",
    titleAr: "سجّل",
    descriptionEn: "Create your account in 2 minutes. No credit card required to get started.",
    descriptionAr: "أنشئ حسابك في دقيقتين. لا حاجة لبطاقة ائتمان للبدء.",
  },
  {
    icon: Settings,
...
const content = {
  en: {
    ...
    subheading: "From signup to launch, we'll guide you every step of the way.",
  },
  ar: {
    heading: "ابدأ في 3 خطوات بسيطة",
    subheading: "من التسجيل إلى الإطلاق، سنوجهك في كل خطوة على الطريق.",
  },
};
