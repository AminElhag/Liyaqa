...
import { usePTTrainerAvailability } from "@liyaqa/shared/queries/use-pt-sessions";
import type { UUID } from "@liyaqa/shared/types/api";
import type { AvailableSlot, BookPTSessionRequest } from "@liyaqa/shared/types/pt-session";
