...
import type { ReferralConfig, UpdateReferralConfigRequest, RewardType } from "@liyaqa/shared/types/referral";
import { REWARD_TYPE_LABELS } from "@liyaqa/shared/types/referral";
