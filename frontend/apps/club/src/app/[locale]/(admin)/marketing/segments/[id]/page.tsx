...
import { useSegment, useSegmentPreview, useRecalculateSegment, useDeleteSegment } from '@liyaqa/shared/queries/use-marketing';
...
import { SEGMENT_TYPE_LABELS } from '@liyaqa/shared/types/marketing';
