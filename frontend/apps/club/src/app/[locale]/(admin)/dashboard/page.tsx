...
import {
  ...
  useTodayAttendance,
} from "@liyaqa/shared/queries/use-dashboard";
import { useRevenueReport, useAttendanceReport } from "@liyaqa/shared/queries/use-reports";
import {
  HeroStats,
  RevenueOverview,
  AttendanceHeatmap,
  ...
  WelcomeBanner,
  AIInsightsBanner,
} from "@liyaqa/shared/components/dashboard";
import { WidgetErrorBoundary } from "@liyaqa/shared/components/error-boundary";
