...
import type { InvoiceStatus } from "@liyaqa/shared/types/billing";
import type { InvoiceLite } from "@liyaqa/shared/types/member-portal";
...
export default function PaymentsPage() {
  ...
  const InvoiceItem = ({ invoice }: { invoice: InvoiceLite }) => (
    <div className="flex items-center justify-between py-4 px-3 border-b last:border-0 hover:bg-muted/50 rounded-lg transition-colors">
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {pendingLoading ? (
          ...
          <Card className="border-red-200 dark:border-red-800/50 bg-red-500/5">
