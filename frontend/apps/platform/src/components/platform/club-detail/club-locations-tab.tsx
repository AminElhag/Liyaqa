...
import { useClubLocations } from "@liyaqa/shared/queries/platform/use-club-detail";
import type { ClubLocation, LocationStatus, GenderPolicy } from "@liyaqa/shared/types/platform";
