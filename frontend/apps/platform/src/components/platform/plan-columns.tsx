...
import type { ClientPlan, BillingCycle } from "@liyaqa/shared/types/platform/client-plan";
import type { Money, LocalizedText } from "@liyaqa/shared/types/api";
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="font-medium">
          {formatCurrency(row.original.monthlyPrice, locale)}
        </span>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <span className="text-muted-foreground">
          {formatCurrency(row.original.annualPrice, locale)}
        </span>
      ),
    },
    {
