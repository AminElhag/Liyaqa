...
import { useClientHealth } from "@liyaqa/shared/queries/platform/use-platform-clients";
import type { ClientHealth, ClientHealthAlertType, ClientHealthAlertSeverity } from "@liyaqa/shared/types/platform/client-health";
import {
  getHealthScoreColor,
  getHealthScoreLabel,
  CLIENT_HEALTH_ALERT_CONFIG,
  CLIENT_SEVERITY_COLORS,
} from "@liyaqa/shared/types/platform/client-health";
