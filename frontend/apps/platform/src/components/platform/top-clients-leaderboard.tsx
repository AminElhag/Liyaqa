...
import { AnimatedCurrency } from "@liyaqa/shared/components/ui/animated-number";
import type { TopClient } from "@liyaqa/shared/types/platform/dashboard";
              ...
              {displayClients.map((client, index) => {
                ...
                return (
                  <motion.div
                    ...
                    animate="visible"
                  >
                    <Link href={`/${locale}/clients/${client.organizationId}`}>
                      <div
                        className={cn(
