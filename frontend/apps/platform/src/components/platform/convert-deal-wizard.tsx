...
import type { ConvertDealFormValues } from "./convert-deal-steps";
import type { OrganizationType } from "@liyaqa/shared/types/organization";
import type { BillingCycle } from "@liyaqa/shared/types/platform/client-plan";
...
export function ConvertDealWizard({
  deal,
  onSubmit,
  onCancel,
  isSubmitting = false,
}: ConvertDealWizardProps) {
  ...
  const texts = {
    ...
    converting: locale === "ar" ? "جاري التحويل..." : "Converting...",
  };
